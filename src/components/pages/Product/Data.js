export const heroObj1 = {
    ...
    textHeader2: "SaronoClotho will allow online clothing retailers to scan their apparel collection using our 3D scanners. The virtual clothes will then be listed in our digital library allowing our app users to virtually try them on their avatars and purchase them."
};
...
export const heroObj3 = {
    ...
    textHeader2: "Our company aims to develop automated rigging algorithms that will allow users to adjust their avatars to pose in the same way that they would have inside a dressing room."
};
...
export const heroObj5 = {
    ...
    textHeader2: "Our app will allow users to visualise their avatars dressed in their clothes of preference. Furthermore, our in-house AI recommendation engine will provide personalised suggestions of matching clothes allowing an even better shopping experience."
};

export const heroObj6 = {
    imgSrc: "/images/ProductImgs/image6.gif",
    textHeader1: "Accurate real-time cloth simulation algorithms",
