...
export const teamMember2 = {
    name: 'Selim Tudgey',
    description: "Selim exposure in business started during her time at the University of the West of England (UWE) studying for a Masters in Research Engineering, where she set up a small clothing shop on the UWE campus after being awarded an entrepreneurial scholarship. She also previously worked as a technical analyst in the automation engineering industry for 4 years understanding and solving technical problems around machinery. She also completed a module in project management and undertook the Be Your Own Boss sessions at UWE Enterprise on Business during her undergraduate years studying for a BEng in Aerospace Engineering. Selim is currently studying for a PhD in Robotics and Autonomous Systems with a research focus on utilising virtual reality in the detection of neurodegenerative diseases. She will be responsible for the business development of SaronoClotho by obtaining all the business and market research necessary to develop the business.",
